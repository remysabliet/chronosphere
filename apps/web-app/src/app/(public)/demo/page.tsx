...
const demoSteps = [
  {
    ...
    description:
      'Select "Introduction to Psychology" to see adaptive learning in action.',
  },
  {
    title: 'Take the Quiz',
    description:
      'Answer questions and watch as the AI adapts to your knowledge level.',
  },
  {
    title: 'Review Memocards',
    description:
      'Explore multimedia flashcards with images, audio, and mnemonics.',
  },
  {
    ...
    <div className='flex flex-col'>
              ...
              <div className='aspect-video bg-gradient-to-br from-brand-50 via-blue-50 to-brand-50 dark:from-brand-950 dark:via-blue-950 dark:to-brand-950 flex items-center justify-center relative'>
                ...
                <div className='relative z-10 text-center'>
                  ...
                  <p className='text-muted-foreground max-w-md mx-auto mb-6'>
                    We're finalizing the interactive demo experience. In the
                    meantime, you can sign up for free to access the full
                    platform.
                  </p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
              ...
              <Card className='h-full hover:shadow-xl transition-shadow duration-300'>
                ...
                <CardContent>
                  <p className='text-muted-foreground'>
                    Watch as the AI adjusts question difficulty based on your
                    responses. Questions become easier or harder in real-time to
            ...
            >
              <Card className='h-full hover:shadow-xl transition-shadow duration-300'>
                ...
                <CardContent>
                  <p className='text-muted-foreground'>
                    Interact with memocards featuring images, audio, and
                    mnemonic techniques. Experience how multi-sensory learning
                    improves retention.
                  </p>
                </CardContent>
              </Card>
      ...
      >
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            <h2 id='demo-cta-heading' className='heading-1 mb-6 text-white'>
              Ready to Get Started?
            </h2>
            <p className='paragraph-lg mb-10 text-white/90'>
              The demo is just a glimpse. Sign up free to unlock the full power
