      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            ...
            <div className="text-center" role="group" aria-label="Quizzes completed">
              <p className="heading-2 gradient-text">2M+</p>
              <p className="text-sm text-muted-foreground">Quizzes Completed</p>
            </div>
            <div className="text-center" role="group" aria-label="Retention rate">
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="paragraph-lg max-w-2xl mx-auto">
                Powered by cutting-edge AI and proven learning science, Memosphere adapts to your unique learning style.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                description: 'Select from thousands of subjects or create your own custom learning path.',
                icon: Target,
              },
              {
                step: '02',
                title: 'Learn Interactively',
                description: 'Engage with multimedia memocards, quizzes, and adaptive exercises.',
                icon: Sparkles,
              },
              {
                step: '03',
                title: 'Master with AI',
                description: 'Our AI adapts to your pace, optimizing review timing for maximum retention.',
                icon: Brain,
              },
            ].map((item, index) => (
              <motion.div
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="paragraph-lg max-w-2xl mx-auto">
                Join thousands of successful learners who transformed their education with Memosphere.
              </p>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            <p className="paragraph-lg mb-10 text-white/90">
              Join 50,000+ learners who are already achieving their goals with Memosphere. Start your free trial today.
            </p>
