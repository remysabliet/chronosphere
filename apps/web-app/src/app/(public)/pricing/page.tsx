...
const comparisonFeatures = [
  {
    ...
    features: [
      { name: 'Adaptive Learning Engine', free: true, pro: true, enterprise: true },
      { name: 'Spaced Repetition System', free: true, pro: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      { name: 'Active Decks', free: '3 decks', pro: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Cards per Deck', free: '100', pro: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Multimedia Support', free: 'Basic', pro: 'Full', enterprise: 'Full' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Collaborative Learning', free: false, pro: true, enterprise: true },
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-center p-4 font-semibold bg-brand-50 dark:bg-brand-950" scope="col">
                        Pro
                      </th>
                      <th className="text-center p-4 font-semibold" scope="col">
                        Enterprise
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="paragraph-lg mb-10 text-white/90">
              Join thousands of learners who are already achieving their goals with Memosphere.
            </p>
            <Button
              asChild
              size="xl"
