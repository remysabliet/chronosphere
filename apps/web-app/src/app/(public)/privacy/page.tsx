...
export const metadata = {
  ...
  description:
    'Privacy Policy for Memosphere. Learn how we collect, use, and protect your data.',
};
          ...
          <Card>
            <CardContent className='prose prose-gray dark:prose-invert max-w-none pt-6'>
              <section aria-labelledby='introduction'>
                ...
                <p>
                  Memosphere ("we", "our", or "us") is committed to protecting
              ...
              <section aria-labelledby='information-collection'>
                ...
                <ul>
                  ...
                  <li>
                    Use our learning features (quiz responses, study sessions)
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Learning Data:</strong> Performance metrics, quiz
                    scores, retention rates, study patterns
                  </li>
                  <li>
                    <strong>Cookies and Tracking:</strong> Session tokens,
                ...
                <p>
                  If you sign in through OAuth providers (Google, GitHub, etc.),
                  we receive basic profile information as permitted by your
              ...
              <section aria-labelledby='how-we-use'>
                ...
                <ul>
                  <li>
                    ...
                    account, deliver learning features
                  </li>
                  <li>
                    <strong>Personalize Experience:</strong> Adapt content
                    difficulty, optimize spaced repetition, provide analytics
                  </li>
                  <li>
                    <strong>Improve the Service:</strong> Analyze usage
                    patterns, develop new features, fix bugs
                  </li>
                  <li>
                    <strong>Communicate:</strong> Send account notifications,
                    updates, marketing communications (with consent)
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    legal requests, enforce our terms
                  </li>
                </ul>
              </section>
              ...
              <section aria-labelledby='legal-basis'>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Legitimate Interests:</strong> Improving the
              ...
              <section aria-labelledby='data-sharing'>
                ...
                <ul>
                  <li>
                    ...
                    analytics (Google Analytics), payment processing (Stripe),
                    email services (SendGrid)
                  </li>
                  <li>
                    <strong>Authentication Providers:</strong> AWS Cognito,
                  ...
                  <li>
                    ...
                    authorize sharing (e.g., collaborative learning features)
                  </li>
                </ul>
              </section>
              ...
              <section aria-labelledby='data-security'>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Secure Infrastructure:</strong> AWS services with
              ...
              <section aria-labelledby='data-retention'>
                ...
                <ul>
                  ...
                  <li>
                    Comply with legal obligations (e.g., tax records for 7
                    years)
                  </li>
              ...
              <section aria-labelledby='your-rights'>
                ...
                <p>
                  ...
                  <strong>privacy@memosphere.com</strong>. We will respond
                  within 30 days.
                </p>
              </section>
              ...
              <section aria-labelledby='cookies'>
                ...
                <ul>
                  <li>
                    <strong>Essential Cookies:</strong> Authentication,
                ...
                <p>
                  ...
                  that disabling essential cookies may affect Service
                  functionality.
                </p>
              </section>
              ...
              <section aria-labelledby='international'>
                ...
                <p>
                  ...
                  countries may have data protection laws different from your
                  jurisdiction.
                </p>
                <p>
                  For EEA users, we use Standard Contractual Clauses approved by
                  the European Commission to ensure adequate protection when
              ...
              <section aria-labelledby='california'>
                ...
                <p>
                  ...
                  <strong>privacy@memosphere.com</strong> or call our toll-free
                  number.
                </p>
              </section>
              ...
              <section aria-labelledby='contact-privacy'>
                ...
                <p>
                  ...
                  <br />
                  <strong>Email:</strong> privacy@memosphere.com
                  <br />
                ...
                <p>
                  For EEA users, you also have the right to lodge a complaint
