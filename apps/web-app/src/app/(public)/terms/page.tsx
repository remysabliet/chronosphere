          ...
          <Card>
            <CardContent className='prose prose-gray dark:prose-invert max-w-none pt-6'>
              <section aria-labelledby='acceptance'>
                ...
                <p>
                  By accessing and using Memosphere ("Service"), you accept and
              ...
              <section aria-labelledby='description'>
                ...
                <p>
                  Memosphere provides an AI-powered adaptive learning platform
                  that includes:
                </p>
                <ul>
                ...
                <p>
                  The Service may change from time to time, at our sole
              ...
              <section aria-labelledby='content'>
                ...
                <ul>
                  <li>
                    ...
                    and permissions to use and authorize us to use all User
                    Content
                  </li>
                  <li>
                    Your User Content does not violate any applicable law or
              ...
              <section aria-labelledby='intellectual-property'>
                ...
                <p>
                  ...
                  features, and functionality are owned by Memosphere and are
              ...
              <section aria-labelledby='subscriptions'>
                ...
                <p>
                  ...
                  ("Subscription"). You will be billed in advance on a recurring
                ...
                <p>
                  ...
                  your Subscription. You agree to provide current, complete, and
              ...
              <section aria-labelledby='refunds'>
                ...
                <p>
                  We offer a 14-day money-back guarantee for paid subscriptions.
                  If you're not satisfied with the Service, you may request a
                  full refund within 14 days of your initial purchase.
                </p>
                <p>
                  Refund requests after 14 days will be evaluated on a
                  case-by-case basis. Recurring subscription payments are
              ...
              <section aria-labelledby='limitation'>
                ...
                <p>
                  IN NO EVENT SHALL MEMOSPHERE, ITS DIRECTORS, EMPLOYEES,
                  PARTNERS, AGENTS, SUPPLIERS, OR AFFILIATES BE LIABLE FOR ANY
                  INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
                  DAMAGES, INCLUDING LOSS OF PROFITS, DATA, USE, OR OTHER
              ...
              <section aria-labelledby='governing-law'>
                ...
                <p>
                  ...
                  with the laws of the jurisdiction in which Memosphere
              ...
              <section aria-labelledby='contact'>
                ...
                <p>
                  <strong>Email:</strong> legal@memosphere.com
                  <br />
                  <strong>Website:</strong>{' '}
                  <a href='https://memosphere.com'>https://memosphere.com</a>
                </p>
              </section>
            </CardContent>
          </Card>
