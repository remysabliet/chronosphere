  ...
  await knex('learning_units').insert([
    {
      ...
      learning_goal: 'Understand the fundamentals of linear regression and its applications',
    ...
    },
    {
      ...
      learning_goal: 'Master the application of Bayes theorem in real-world scenarios',
      bloom_levels_supported: ['Understanding', 'Applying', 'Analyzing', 'Evaluating'],
  ...
  await knex('questions').insert([
    {
      ...
      explanation: 'Linear regression is used to predict continuous numerical values by finding the best line through data points.',
    ...
    },
    {
      ...
      guessing_c: 0.25,
      question_type: '4-option MCQ',
      question_text: 'Given the equation y = 2x + 3, what would be the predicted value when x = 5?',
      options: JSON.stringify(['10', '11', '13', '15']),
      correct_answer: '13',
      explanation: 'Substituting x = 5 into the equation: y = 2(5) + 3 = 10 + 3 = 13',
